...
function Index() {
  return (
	...
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"
                          ...
                          <div className="form-group">
                            <div className="col-md-12">
                              <label className=" control-label">What is your Name of the Covered Entity? </label>
                              <input
                                type="text"
                                className="form-control"
                                name="zip"
                                defaultValue
                                placeholder="Name of the Covered Entity"
                          ...
                          <p>
                            We apologize that your HealthCare Covered Entity may not yet be listed with us. Please complete this form and one of our HealthCare specialists will contact you within 48
                            hours to listen to your needs. Thank you for selecting Ginicoe
                          </p>
                          <div className="form-group">
